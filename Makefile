...
smoke:
	...
	$(VERILATOR) --binary --sv --timing --assert -Wall -Wno-fatal --top-module tb_i2c_smoke --Mdir build/obj_i2c rtl/i2c_master_write.sv tb/models/i2c_slave_model.sv tb/smoke/tb_i2c_smoke.sv
	./build/obj_i2c/Vtb_i2c_smoke|tee results_smoke.log
clean:
